...
namespace src.Model.PathFinding
{
    public class PathFinderAStar : IPathFindingStrategy
    {
        ...
        /// <exception cref="ArgumentNullException">Thrown if map or source/target coordinates are null</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown if source or target are out of map bounds</exception>
