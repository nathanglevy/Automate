...
namespace Model.MapModelComponents
{
    ...
    public class Coordinate : Object
    {
        ...
        //Operator is defined to check if the upperLeft coordinate is in the bottom right quad
        //relative to bottomRight.
        ...
        //Operator is defined to check if the upperLeft coordinate is in the left top quad
        //relative to bottomRight.
        public static bool operator <(Coordinate c1, Coordinate c2) {
            if ((object)c1 == null || (object)c2 == null)
                return false;
