...
namespace AutomateTests.Model.PathFinding {
    ...
    public class TestMovementPath {
        ...
        public void TestGetNextMovement_ExpectCorrectValues() {
            ...
            movementPath.AddMovement(new Movement(new Coordinate(0, 0, 1), 1));
            movementPath.AddMovement(new Movement(new Coordinate(0, 1, 1), 1));
            Assert.AreEqual(new Movement(new Coordinate(0, 0, 1), 1), movementPath.GetNextMovement(new Coordinate(0, 0, 0)));
            Assert.AreEqual(new Movement(new Coordinate(0, 0, 1), 1), movementPath.GetNextMovement(new Coordinate(0, 0, 1)));
            Assert.AreEqual(new Movement(new Coordinate(0, 1, 1), 1), movementPath.GetNextMovement(new Coordinate(0, 0, 2)));
        }
