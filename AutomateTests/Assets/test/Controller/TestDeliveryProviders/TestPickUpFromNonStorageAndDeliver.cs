...
namespace AutomateTests.Assets.test.Controller.TestDeliveryProviders
{
    ...
    {
        public override DeliveryCost CalcScenarioCost(RequirementJob requirmentJob, ITransportRequirement requirement, Coordinate Destination,
            IGameWorld gameWorld)
        {
            throw new NotImplementedException();
        }

        public override DeliveryCost CalcScenarioCost(RequirementJob structureCurrentJob, ITransportRequirement requirement,
